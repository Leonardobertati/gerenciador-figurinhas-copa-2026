...
if (!hasEntry(result.existing, "BRA1", 4) || !hasEntry(result.existing, "BRA2", 2)) failures.push("Figurinhas ja possuidas devem descontar uma ja colada na quantidade exibida.");
